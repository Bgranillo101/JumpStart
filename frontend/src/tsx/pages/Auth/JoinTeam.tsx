...
import { registerUser, login, searchCompanies, addMember, decodeJwt, joinByInviteCode } from '../../api';
...
export default function JoinTeam() {
  ...
  const [pendingInvite] = useState(() => localStorage.getItem('pendingInviteCode'));
      ...
      <div className="wizard-card">
        {pendingInvite ? (
          <form onSubmit={handleInviteJoin}>
            <h1 className="wizard-title">Join via Invite</h1>
            <p className="wizard-subtitle">You've been invited to join a team! Create your account below.</p>
            ...
            <Button type="submit" variant="primary" size="lg" fullWidth disabled={loading}>
              {loading ? 'Joining…' : 'Create Account & Join Team'}
            </Button>
          </form>
        ) : (
          <>
